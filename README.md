...
| Thursday<br>04/06/16 | Jupyter,pandas    |[Pandas [1][19],[2][21]<br>[Extra1][20],[Extra2][22]|[sql-python][25.1]<br>[pandas][23]    | Erich | Steve | [slides][23.1],[2][23.2] | [sql-python](https://github.com/kykiefer/sql-python)<br>[pandas](null) | [SQL-python](https://github.com/kykiefer/DSI_notes/blob/master/daily_slides/w1/sql-python-slides.pdf) |
...
| Friday<br>04/14/16   | multi-armed bandit | *no reading*                                                               | [Multi-armed bandit][44]                 | Adam  | Steve | [slides][40.5] | [Multi-armed Bandit](https://github.com/kykiefer/multi-armed-bandit) |
...
| Day                  | Main Topics        | Readings                                                                   | Repo                                     | Lead  | Deck  | Slides         | My Repo | Daily Slides |
|:---------------------|:-------------------|:---------------------------------------------------------------------------|:----------------------------------------:|:------|:-----:|:--------------:|:-----:|:-----:|
| Monday<br>04/17/17   | NumPy, Linear Reg. |[Linear Algebra][45]<br>[SL (3-3.2, pg 59-82)][47.1]<br>[Optional][45.1] |[Linear Algebra, EDA, Lin. Reg.][48]             | Frank      | Brent  |[slides][45.2] | [Linear Algebra, EDA, Lin. Reg.](https://github.com/kykiefer/linear-algebra-eda) |
| Tuesday<br>04/18/17  | More Linear Reg.   |[ISLR (3.3-3.4, pg 82-104)][47.1]                                        |[Linear Regression 2][58]                        | Adam       | Steve  |[slides][45.3] | [Linear Regression 2](https://github.com/kykiefer/linear-regression) |
| Wednesday<br>04/19/17| Regularization, CV |[ISLR (5-5.1.4, pg 175-184)][47.1]<br>[SL (6.2, pg 214-228)][47.1]       |[Cross Validation & Regularization][54]          | Frank      | Brent  |[slides][54.1] | [Cross Validation & Regularization](https://github.com/kykiefer/regularized-regression) |
| Thursday<br>04/20/17 | ROC, Logistic Reg. |[ISLR (pg 127-137)][47.1]<br>[ML in action (pg 142-148)][MLIA]           |[Logistic Reg.][log-reg]                         | Adam       | Steve  |[slides][54.2] | [Logistic Reg.](https://github.com/kykiefer/logistic-regression) |
| Friday<br>04/21/17   | Data Visualization |*no reading*                                                             |[Assessment 3][A3]<br>[Data Visualization][150.1]| Steve      | Adam   |[slides][150.2]| [Data Visualization](https://github.com/kykiefer/data-viz-for-ds) |
...
| Wednesday<br>04/26/17 |Bagging, Random Forests|[ISLR (8.1.2-8.2.2, pg 311-321)][47.1]                            |[Bagging & Random Forests][68]                | Brent | Frank | [slides][68.1] |[Bagging & Random Forsets](https://github.com/kykiefer/random-forest) |
...
| Friday<br>05/05/17   | clustering         | [ISLR (pg 385-400)][47.1]                                          | [KMeans and Hierarchical Clustering][104]           | Frank  | Steve | [1][104.1]     | [KMeans and Hierarchical Clustering](https://github.com/kykiefer/clustering) |
...
| Thursday<br>05/11/17 | profit curves, map-red |[DSFB][DSBus] (pg 194-203, 212-214) <br> [ISLR (8.2.3, pg 321-324)][47.1] |[Profit Curves][profit]<br>[MR][129]     | Frank | Adam  |[1][122.3], [2][71.4]| [Profit Curves](https://github.com/kykiefer/profit-curve)<br>[MR](https://github.com/kykiefer/data-at-scale) |
...
| Thursday<br>05/25/17 | Recommendors          |[ML in Action][MLIA] (pg 286-295)  (especially 9.1, 9.3, 9.5)         | [Recommendation Systems][118]          | Adam     | Frank | [slides][103.4]| [Recommendation Systems](https://github.com/kykiefer/recommendation-systems) |
...
| Thursday<br>06/01/17 | *case study*          | Fraud Detection Case Study (continued)                                          | [Fraud Detection Case Study][135] | Brent     |          |                | [Fraud Detection Case Study](https://github.com/kykiefer/case-study) |
